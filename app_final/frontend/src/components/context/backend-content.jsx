    ...
    const fetchTenders = async () => {
        try {
            ...
            const newTenders = data.map((tender) => {return {
                ...
                link: tender.registry_number[0] == "0" ? `https://zakupki.gov.ru/epz/order/notice/zk20/view/common-info.html?regNumber=${tender.registry_number}` : `https://zakupki.gov.ru/epz/order/notice/notice223/common-info.html?regNumber=${tender.registry_number}`
            }})
