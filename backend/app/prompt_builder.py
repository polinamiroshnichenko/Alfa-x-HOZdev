...
DEFAULT_INSTRUCTION = (
    ...
    "Если информации недостаточно, честно скажи об этом одной короткой фразой, например: 'Информации недостаточно'. "
...
Не добавляй лишней информации, которая не указана в данных.
Если данных недостаточно - честно скажи, что не хватает информации. 
"""
    return prompt
